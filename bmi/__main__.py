...
def cli():
    ...
    sub_cmd_calculate.add_argument('weight', metavar='weight', type=int, nargs=1, help='weight in kilograms (e.g. 80)')
    ...
    sub_cmd_calculate_w_info.add_argument('weight', metavar='weight', type=int, nargs=1, help='weight in kilograms (e.g. 80)')
    ...
    sub_cmd_calculate_weight.add_argument('bmi', metavar='bmi', type=int, nargs=1, help='Body Mass Index (BMI) value (e.g. 22)')
