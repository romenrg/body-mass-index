...
def cli():
    ...
    sub_cmd_calculate = subparsers.add_parser('calculate_bmi', help='Calculate BMI, provided weight (kg) and height (m) [info]')
    ...
    sub_cmd_calculate.add_argument('--info', metavar='lang', type=str, nargs='?', const='en', help='Display info. Valid lang values: <"en" (default) or "es">')
    sub_cmd_range_info = subparsers.add_parser('get_bmi_range_info', help='Return range info, provided BMI and language')
    ...
    sub_cmd_calculate_weight = subparsers.add_parser('calculate_weight', help='Calculate weight (kg), provided height (m) and BMI')
    ...
    sub_cmd_weight_ranges = subparsers.add_parser('calculate_weight_ranges_info', help='Calculate weight ranges (kg), based on BMI ranges; provided height (m)')
    ...
    sub_cmd_healthy_weight = subparsers.add_parser('calculate_healthy_weight', help='Calculate healthy weight range (kg), provided height (m)')
